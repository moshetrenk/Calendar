...
public class JavaMenuBarExample implements Runnable, ActionListener
{
  ...
  private JMenuItem friendMenuItem;
  ...
  public void run()
  {
    ...
    eventMenuItem = new JMenuItem("Event");
    friendMenuItem = new JMenuItem("Friend");
    groupMenuItem = new JMenuItem("Group");
    addMenu.add(eventMenuItem);
    addMenu.add(friendMenuItem);
    addMenu.add(groupMenuItem);
